...
# 設置頁面配置
st.set_page_config(
    page_title="AWS CLF-C02 Quiz",  # 頁面標題
    page_icon="🚀",  
...
# st.sidebar.markdown("""
# **AWS AIF-C01 和 AWS CLF-C02 參考題**\n 
# *(含選擇及複選題)* 

# st.sidebar.markdown("""Choose the quiz you want to practice.✒️
#                     """)
